...
from proofgym.worlds.museum_duo.missions import mission_for_id
...
class MuseumDuoWorld:
    ...
    def load_instance(self, instance_id: str) -> Instance:
        ...
        Args:
            instance_id: ``museum_duo.v0.<mission>.<variant>``.
        ...
        try:
            ...
            raise KeyError(f"unknown museum_duo instance: {instance_id}") from exc
