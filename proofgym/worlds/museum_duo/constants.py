"""Duo museum vocabulary: rooms, doors, objects, actors. Not imported by ``core``.

Deliberately a copy of ``worlds/museum/constants.py`` plus the two-actor
roster (PLAN_MULTIAGENT.md M8, copy-on-write): the duo world must not inherit
future single-agent additions (e.g. the OG crate family) by accident.
"""
...
ACTOR_E = "E"
ACTOR_H = "H"
ACTORS: tuple[str, str] = (ACTOR_E, ACTOR_H)
